...
class TestGame2048Helper {
    ...
    @Test
    fun myTest1() = testMerge(listOf("b", "a", "a", "a"), listOf("b", "aa", "a"))

    @Test
    fun myTest2() = testMerge(listOf("b", "a", "a", null), listOf("b", "aa"))

    @Test
    fun myTest3() = testMerge(listOf("b", "a", null, "a"), listOf("b", "aa"))
